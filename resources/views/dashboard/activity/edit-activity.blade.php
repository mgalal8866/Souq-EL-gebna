<div>
    <form id="newproductForm" wire:submit.prevent="saveactivity">
        <div class="card">
            <div class="card-header">
                <h4 class="card-title">{{ __('tran.dataactivity') }}</h4>
            </div>
        ...
        <div class="card">
            <div class="card-footer">
                <div class="col-12 text-center mt-2 pt-50">
                    ...
                    <a class="btn btn-outline-secondary" href="{{ route('activitys') }}">
                        Cancel
                    </a>
                </div>
            </div>
